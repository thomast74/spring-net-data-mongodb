...
namespace Spring.Data.MongoDb.Core.HelperClasses
{
    ...
    [Document(CollectionNameName = "persons")]
    public class PersonWithAttribute
    {
	    ...
	    public PersonWithAttribute(ObjectId id, String firstname) 
        {
		    _id = id;
		    _firstName = firstname;
	    }

	    public PersonWithAttribute(String firstname, int age)
            : this()
        {
		    _firstName = firstname;
		    _age = age;
        ...
        public PersonWithAttribute(String firstname)
            : this()
        {
		    _firstName = firstname;
	    }
	    ...
	    public override bool Equals(Object obj)
        {
            ...
            PersonWithAttribute that = (PersonWithAttribute)obj;
