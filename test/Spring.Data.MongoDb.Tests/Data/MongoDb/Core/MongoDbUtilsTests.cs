// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MongoDbUtilsTest.cs" company="The original author or authors.">
...
namespace Spring.Data.MongoDb.Core
{
    ...
    public class MongoDbUtilsTest
    {
        ...
        public void Setup()
        {
            ...
            _mongo.GetDatabase(Arg.Any<string>()).Returns(x => MongoTestHelper.GetMockMongoDatabase((string)x[0]));
