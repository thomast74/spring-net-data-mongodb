...
{
    /// <summary>
    /// Unit tests for <see cref="SimpleMongoDbFactory" />
    /// </summary>
    ...
    public class SimpleMongoDbFactoryTests
    {
        ...
        {
	        new SimpleMongoDbFactory(_mongo, "foo-bar");
	        new SimpleMongoDbFactory(_mongo, "foo_bar");
	        new SimpleMongoDbFactory(_mongo, "foo01231bar");
	    ...
	    public void MongoUriConstructor() 
        {
            ...
            IMongoDbFactory mongoDbFactory = new SimpleMongoDbFactory(uriBuilder.ToMongoUrl());
	    ...
	    private void RejectsDatabaseName(string databaseName)
        {
		    try 
            {
			    new SimpleMongoDbFactory(_mongo, databaseName);
