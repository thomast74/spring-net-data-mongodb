...
namespace Spring.Data.MongoDb
{
    ...
    public static class MongoTestHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static MongoDatabase GetMockMongoDatabase(string databaseName)
        {
        ...
        {
            var collectionSetting = new MongoCollectionSettings<T>(GetMockMongoDatabase("databaseName"), typeof(T).Name);
            var m = Substitute.For<MongoCollection<T>>(GetMockMongoDatabase("databaseName"), collectionSetting);
            m.Database.Returns(GetMockMongoDatabase("databaseName"));
